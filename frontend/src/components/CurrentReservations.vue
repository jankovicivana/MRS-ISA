                  ...
                  <div>
                    <table class="table">
                      ...
                      <tr style="background: #ede4da;" v-for="reservation in reservations">
                        ...
                        <td v-if="!reservation.client.deleted"><button v-on:click="makeReservation(reservation.client.id)" style="background: #2e6b6b; border-radius: 8px;color: #FFFFFF; border-color: #FFFFFF">Add reservation</button></td>
                        <td v-if="reservation.client.deleted"><button class="button" v-on:click="makeReservation(reservation.client.id)" disabled style="background: #2e6b6b; border-radius: 8px;color: #FFFFFF; border-color: #FFFFFF">Add reservation</button></td>
                      </tr>
                      </tbody>
