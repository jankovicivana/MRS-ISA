<template>
  <section class="add_cottage vh-80">
              ...
              <div class="card-body p-5">
                ...
                <form>
                  ...
                  <div class="d-flex justify-content-center">
                    <button type="button" v-on:click="addCottage()" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body" style="background-color: #04414d;"><div style="color:white">Add cottage</div></button>
                  </div>
                </form>
              </div>
            </div>
...
export default {
  ...
  methods:{
    ...
    addImage: function (){
      ...
      let tag,aptag;
      [tag,aptag] = this.formElement(img,this.images);
    ...
    addCottage: function (){
      ...
      axios.post("https://rental-app-6.herokuapp.com"+"/api/cottages/addCottage",this.info, {headers: {Authorization:
