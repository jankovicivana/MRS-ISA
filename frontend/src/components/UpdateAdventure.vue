...
export default {
  ...
  mounted: function (){
    axios
      .get("https://rental-app-6.herokuapp.com"+"/api/adventures/"+this.id, {headers: {Authorization:
  ...
  methods:{
    ...
    addImage: function (){
      ...
      picturePath.onload = e => {
        axios.post("https://rental-app-6.herokuapp.com"+"/api/images/addImage", {data:e.target.result,path:file.name,entityId:2}, {headers: {Authorization:
              'Bearer ' + sessionStorage.getItem("accessToken")}})
          .then(response => {
    ...
    addRule: function (){
      ...
      axios.post("https://rental-app-6.herokuapp.com"+"/api/rules/addRule", {rule:ruleText,entityId:2}, {headers: {Authorization:
            'Bearer ' + sessionStorage.getItem("accessToken")}})
        .then(response => {
    ...
    addService: function (){
      ...
      axios.post("https://rental-app-6.herokuapp.com"+"/api/additionalServices/addAdditionalService", {name:service,entityId:2}, {headers: {Authorization:
            'Bearer ' + sessionStorage.getItem("accessToken")}})
        .then(response => {
    ...
    addEquipment: function (){
      ...
      axios.post("https://rental-app-6.herokuapp.com"+"/api/equipment/addFishingEquipment", {equipment:enteredEquipment,adventureId:2,boatId : -1}, {headers: {Authorization:
            'Bearer ' + sessionStorage.getItem("accessToken")}})
        .then(response => {
    ...
    updateAdventure: function (){
      ...
      axios.put("https://rental-app-6.herokuapp.com"+"/api/adventures/updateAdventure",this.info, {headers: {Authorization:
            'Bearer ' + sessionStorage.getItem("accessToken")}})
        .then(response => {
