...
insert into clients (id, email, password, name, surname, phone_number, type, address, penalties, points,main_photo,deleted, enabled) values (nextval('my_seqv1'), 'ivanaj0610+a@gmail.com', '$2a$10$sUvGKGniC4ZePlmC.QvUWOxlwzbEYjg11Dhr7XE/l1fvrKKPWym6K', 'ivana', 'kasikovic', '065', 3, 2, 0, 0,'pera2.jpg',false, true);
...
insert into boats (id, deleted, description, name, price, address, motor_num, cancel_fee, capacity, length, max_speed, power, type, boat_owner, average_grade, kind)
...
insert into quick_reservations (discount, end_date_time, expiration_date_time, is_reserved, max_person_num, price,
                                start_date_time, entity, reservation,discounted_price,deleted)
values (10,'20220630','20220625 10:00:00 AM',false,10,200,'20220629',1,null,180,false);

insert into quick_reservations (discount, end_date_time, expiration_date_time, is_reserved, max_person_num, price,
                                start_date_time, entity, reservation,discounted_price,deleted)
values (5,'20220628','20220626 10:00:00 AM',false,10,180,'20220627',1,null,170,false);

insert into quick_reservations (discount, end_date_time, expiration_date_time, is_reserved, max_person_num, price,
                                start_date_time, entity, reservation,discounted_price,deleted)
values (5,'20220628','20220626 10:00:00 AM',false,10,180,'20220627',4,null,170,false);

insert into quick_reservations (discount, end_date_time, expiration_date_time, is_reserved, max_person_num, price,
                                start_date_time, entity, reservation,discounted_price,deleted)
values (5,'20220630','20220626 10:00:00 AM',false,10,180,'20220627',5,null,170,false);

insert into quick_reservations (discount, end_date_time, expiration_date_time, is_reserved, max_person_num, price,
                                start_date_time, entity, reservation,discounted_price,deleted)
values (5,'20220628','20220626 10:00:00 AM',false,10,180,'20220627',6,null,170,false);

insert into quick_reservations (discount, end_date_time, expiration_date_time, is_reserved, max_person_num, price,
                                start_date_time, entity, reservation,discounted_price,deleted)
values (5,'20220528 10:00:00 AM','20220525 10:00:00 AM',false,10,150,'20220526 10:00:00 AM',2,null,120,false);

insert into quick_reservations (discount, end_date_time, expiration_date_time, is_reserved, max_person_num, price,
                                start_date_time, entity, reservation,discounted_price,deleted)
values (10,'20220720 10:00:00 AM','20220701 10:00:00 AM',false,10,200,'20220715 10:00:00 AM',2,null,150,false);

insert into quick_reservations (discount, end_date_time, expiration_date_time, is_reserved, max_person_num, price,
                                start_date_time, entity, reservation,discounted_price,deleted)
values (10,'20220701 10:00:00 AM','20220628 10:00:00 AM',false,10,200,'20220630 10:00:00 AM',9,null,150,false);

insert into quick_reservations (discount, end_date_time, expiration_date_time, is_reserved, max_person_num, price,
                                start_date_time, entity, reservation,discounted_price,deleted)
values (5,'20220629 10:00:00 AM','20220525 10:00:00 AM',false,10,180,'20220626 10:00:00 AM',3,null,13,false);
...
insert into reservations(start_date_time,end_date_time,deleted,entity,price,system_profit,advertiser_profit,person_num,is_canceled,client) values
    ('20210522 10:00:00 AM','20210527 10:00:00 AM',false,1,200,20,120,5,false,2);

insert into reservations(start_date_time,end_date_time,deleted,entity,price,system_profit,advertiser_profit,person_num,is_canceled,client) values
    ('20220615 10:00:00 AM','20220628 10:00:00 AM',false,1,200,20,180,5,false,2);

insert into reservations(start_date_time,end_date_time,deleted,entity,price,system_profit,advertiser_profit,person_num,is_canceled,client) values
    ('20220630 10:00:00 AM','20220705 10:00:00 AM',false,1,500,20,250,5,false,2);

insert into reservations(start_date_time,end_date_time,deleted,entity,price,system_profit,advertiser_profit,person_num,is_canceled,client) values
    ('20220712 10:00:00 AM','20220720 10:00:00 AM',false,1,200,20,60,5,false,2);


insert into reservations(start_date_time,end_date_time,deleted,entity,price,system_profit,advertiser_profit,person_num,is_canceled,client) values
    ('20210530 10:00:00 AM','20210605 10:00:00 AM',false,1,200,20,60,5,false,2);

insert into reservations(start_date_time,end_date_time,deleted,entity,price,system_profit,advertiser_profit,person_num,is_canceled,client) values
    ('20220602 10:00:00 AM','20220606 10:00:00 AM',false,3,150,20,130,5,false,2);

insert into reservations(start_date_time,end_date_time,deleted,entity,price,system_profit,advertiser_profit,person_num,is_canceled,client) values
    ('20220705 10:00:00 AM','20220711 10:00:00 AM',false,3,300,20,250,5,false,2);

insert into reservations(start_date_time,end_date_time,deleted,entity,price,system_profit,advertiser_profit,person_num,is_canceled,client) values
    ('20220619 10:10:00 AM','20220627 10:00:00 AM',false,3,500,20,400,5,false,2);
...
insert into available_periods (start_date_time, end_date_time,entity,fishing_instructor) values ('20220701', '20220730', 1,null);
